...
import { Chart2, Chart3 } from "../components/Chart";
...
function DashboardPage() {
    ...
    const validateMoney = (money) => {
        if (money >= 1000000000) {
            ...
            return `${(money / 1000000).toFixed(2)} triệu`;
        } else if(money < 0) {
            if (money <= -1000000000) {
                return `${(money / 1000000000).toFixed(2)} tỷ`;
            }
            ...
            <div className="col-lg-8">
                <div className="row">
                    <Card icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-auto" viewBox="0 0 16 16">
                        ...
                        title={`Tổng tiền mặt`}
                        style="bg-primary"
                        value={validateMoney(data.totalCash)} />
                    <Card icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-auto" viewBox="0 0 16 16">
                                    <path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.5.5 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89zM3.777 3h8.447L8 1zM2 6v7h1V6zm2 0v7h2.5V6zm3.5 0v7h1V6zm2 0v7H12V6zM13 6v7h1V6zm2-1V4H1v1zm-.39 9H1.39l-.25 1h13.72z"/>
                                </svg>}
                        title={`Tổng tiền gửi`}
                        style="bg-success"
                        value={validateMoney(data.totalBankDeposit)} />
                    <Card icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-auto" viewBox="0 0 16 16">
                        ...
                        style="bg-info"
                        value={validateMoney(data.totalReceivable)} />
                    <Card icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-auto" viewBox="0 0 16 16">
                        ...
                        style="bg-danger"
                        value={validateMoney(data.totalPayable)} />
                </div>
                <div className="row">
                    <div className="col-sm-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body d-flex justify-content-center">
                                <Chart2 data={data.monthlyTransactions} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="col-lg-4">
                ...
                <div className="row">
                    <div className="col-sm-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <Chart3 data={data.yearlyRevenue} />
                            </div>
                        </div>
                    </div>
                </div>
